...
/// Activates one board position without embedding UI-source-specific rules.
///
/// The BLoC interprets it against its latest state as selection, reselection,
/// deselection, or a move. Touch and accessibility inputs can share this path.
class ActivateBoardPositionEvent extends GameEvent {
  final Position position;

  const ActivateBoardPositionEvent(this.position);

  @override
  List<Object?> get props => [position];

  @override
  String toString() => 'ActivateBoardPositionEvent(position: $position)';
}
